...
internal fun RegistrationScreen(viewModel: RegistrationViewModel, onClick: () -> Unit) {
    ...
    Column(
        ...
        // Continue button
        Button(
            onClick = { viewModel.registrationBonus(phoneNumber, name, address) },
            enabled = name.isNotBlank() && address.isNotBlank() && phoneNumber.isNotBlank(), // Enable based on validation
            modifier = Modifier
                .fillMaxWidth()
